...
#
#   ./bench-matrix.sh                                   # this repo's prod stack (vLLM+MTP)
#   BASE_URL=http://127.0.0.1:9000 MODEL=my-model ./bench-matrix.sh  # other engines
#   API_KEY= ./bench-matrix.sh                          # no auth (default: key file)
#
